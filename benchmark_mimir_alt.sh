...
sizes=(10000 25000 50000 75000 100000 125000 150000 175000 200000 225000 250000 275000 300000)
mode=${modes[${1}]}
opts=${options[${1}]}
file=${folder}/nbody_mimir_${mode}.csv
echo "mode,windowres,N,framerate,compute_time,pipeline_time,graphics_time,vk_usage,vk_budget,gpu_power,gpu_energy,gpu_time,nvml_free,nvml_reserved,nvml_total,nvml_used,pack_time,d2h_time,h2h_time" >> ${file}
...
for i in {0..1}; do
    ...
    echo "mode,windowres,N,seed,k,epsilon,framerate,compute_time,pipeline_time,graphics_time,vk_usage,vk_budget,gpu_power,gpu_energy,gpu_time,nvml_free,nvml_reserved,nvml_total,nvml_used,pack_time,d2h_time,h2h_time,spp,bounces,subdiv,tlas_time,trace_time" >> ${file}
    for exp in {4..9}; do
        size=$((10**${exp}))
        echo "    mode: ${mode}; size: ${size}"
